...
export namespace Prisma {
  ...
  */
  ...
  export interface ChatDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * 
     * // Only select the `mongo_id`
     * const chatWithMongo_idOnly = await prisma.chat.findMany({ select: { mongo_id: true } })
     * 
     */
  ...
  interface ChatFieldRefs {
    readonly mongo_id: FieldRef<"Chat", 'String'>
  ...
  export type ChatWhereInput = {
    ...
    mongo_id?: StringFilter<"Chat"> | string
  ...
  export type ChatScalarWhereWithAggregatesInput = {
    ...
    mongo_id?: StringWithAggregatesFilter<"Chat"> | string
